...
function gambit_control_post_content_callback( $control ) {
	...
	if ( 'excerpt' === $control->manager->get_setting( 'gambit_theme_options[post_content]' )->value() ) :
		return true;
	else :
		return false;
	endif;
...
function gambit_slider_activated_callback( $control ) {
	...
	if ( true === $control->manager->get_setting( 'gambit_theme_options[slider_blog]' )->value() ) :
		return true;
	elseif ( true === $control->manager->get_setting( 'gambit_theme_options[slider_magazine]' )->value() ) :
		return true;
	else :
		return false;
	endif;
