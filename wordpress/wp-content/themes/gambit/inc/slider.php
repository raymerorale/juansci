...
function gambit_slider_scripts() {
	...
	if ( true === $theme_options['slider_blog'] or true === $theme_options['slider_magazine'] or is_page_template( 'template-slider.php' ) ) :
		...
		wp_enqueue_script( 'gambit-slider', get_template_directory_uri() . '/js/slider.js', array( 'jquery-flexslider' ), '20170421' );

		// Register and enqueue slider CSS.
		wp_enqueue_style( 'gambit-slider', get_template_directory_uri() . '/css/flexslider.css', array(), '20170421' );
