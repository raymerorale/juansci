 ...
 */
class Magazinews_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazinews_Dropdown_Category_Control extends WP_Customize_Control {
...
class Magazinews_Note_Control extends WP_Customize_Control {
...
class Magazinews_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Magazinews_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="magazinews-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Magazinews_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class Magazinews_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
