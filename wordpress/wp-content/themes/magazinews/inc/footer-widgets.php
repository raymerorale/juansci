...
class Magazinews_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'magazinews';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'magazinews' ), $i ),
...
// Initialize.
$magazinews_footer_widgets = new Magazinews_Footer_Widgets();
